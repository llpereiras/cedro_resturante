class PratosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @prato.save
        format.html { redirect_to pratos_path, notice: 'Prato foi criado.' }
  ...
  def update
    respond_to do |format|
      if @prato.update(prato_params)
        format.html { redirect_to pratos_path, notice: 'Prato foi atualizado.' }
  ...
  def destroy
    @prato.destroy
    respond_to do |format|
      format.html { redirect_to pratos_path, notice: 'Prato foi excluído.' }
